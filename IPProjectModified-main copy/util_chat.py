...
class ChatHall:
    ...
    def msg_handler(self, member, msg):
        ...
        if "name:" in msg:
            ...
            if len(msg.split()) >=2:
                broadmessage = msg.split()[1:]
                Room.broadcast_message(member,broadmessage)
...
class Room:
    ...
    def broadcast_message(self,member, msg):
        broadmessage1 = msg.encode() + msg
        self.broadcast(member,broadmessage1)
