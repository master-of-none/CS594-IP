"""
    ...
    This is the Server Program to connect to the client
"""

import select

import util_chat
from util_chat import ChatHall, ChatMember
...
connection_list = [listenSocket]
# All the sockets and server sockets and appending to the client socket
